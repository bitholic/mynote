            ...
            case 'note':
                return (
                    <Container>
                        ...
                        <Content>
                            <Text style={{fontSize: 50}}>React Native JS code runs inside this Chrome tab. Press to open Developer Tools. Enable Pause On Caught Exceptions for a better debugging experience. Status: Debugger session #13265 active.</Text>
                        </Content>
                    </Container>
                );
            case 'bill':
